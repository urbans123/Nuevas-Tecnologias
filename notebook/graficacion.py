# Se importa matplotlib para crear los graficos
...
# Ruta tipica de la carpeta assets en un proyecto React con Vite
...
def graficar_lineas(datos_agrupados, columna_eje_x, columna_eje_y,
    ...
    # Se crea la figura y el area de dibujo con un tamaño de 10 de ancho por 5 de alto
    ...
    # Se coloca el titulo del grafico con tamaño de fuente 14
...
def graficar_torta(datos_agrupados, columna_etiquetas, columna_valores,
    ...
    # Se crea la figura y el area de dibujo con tamaño cuadrado de 8 por 8
...
def graficar_mapa_calor(datos_agrupados, columna_filas, columna_columnas, columna_valores,
    ...
    # Se crea la figura y el area de dibujo con un tamaño de 10 de ancho por 6 de alto
    figura, area_dibujo = plt.subplots(figsize=(10, 6))

    # Se dibuja el mapa de calor con valores anotados, paleta de color y lineas divisorias
    sns.heatmap(
        tabla_pivote,
        annot=True,
        fmt=".0f",
